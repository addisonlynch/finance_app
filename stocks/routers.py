class StocksDatabaseRouter(object):
    """
    ...
    def allow_relation(self, obj1, obj2, **hints):
        ...
        if obj1._meta.app_label == 'stocks' and obj2._meta.app_label == 'stocks':
            return True
        # No opinion if neither object is in the Example app (defer to default or other routers).
        elif 'stocks' not in [obj1._meta.app_label, obj2._meta.app_label]:
            return None
